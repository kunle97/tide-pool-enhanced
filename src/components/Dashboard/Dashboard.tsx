      ...
      <div className='container-fluid'>
                ...
                <div className='row align-items-center no-gutters'>
                  <div className='col me-2'>
                    <div className='text-uppercase text-primary fw-bold text-xs mb-1'>
                      <span className='card-header-text'>Earnings (monthly)</span>
                    </div>
                ...
                <div className='row align-items-center no-gutters'>
                  <div className='col me-2'>
                    <div className='text-uppercase text-success fw-bold text-xs mb-1'>
                      <span className='card-header-text'>Earnings (annual)</span>
                    </div>
                    <div className='text-dark fw-bold h5 mb-0'>
                ...
                <div className='row align-items-center no-gutters'>
                  <div className='col me-2'>
                    <div className='text-uppercase text-info fw-bold text-xs mb-1'>
                      <span className='card-header-text'>Tasks</span>
                    </div>
                    <div className='row g-0 align-items-center'>
                      ...
                      <div className='col'>
                        <div className='progress progress-sm '>
                          <div
                            className='progress-bar bg-success w-2/4'
                            aria-valuenow={50}
                            aria-valuemin={0}
                            aria-valuemax={100}
                          >
                ...
                <div className='row align-items-center no-gutters'>
                  <div className='col me-2'>
                    <div className='text-uppercase text-warning fw-bold text-xs mb-1'>
                      <span className='card-header-text'>Pending Requests</span>
                    </div>
                    <div className='text-dark fw-bold h5 mb-0'>
        ...
        <div className='row'>
          <div className='col-lg-7 col-xl-8'>
            <div className='card shadow mb-4'>
              <div className='card-header d-flex justify-content-between align-items-center'>
                <h6 className='text-primary fw-bold m-0 card-header-text'>Earnings Overview</h6>
              ...
              <div className='card-body'>
                <div className='chart-area'>
                  <canvas data-bss-chart='{"type":"line","data":{"labels":["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug"],"datasets":[{"label":"Earnings","fill":true,"data":["0","10000","5000","15000","10000","20000","15000","25000"],"backgroundColor":"rgba(78, 115, 223, 0.05)","borderColor":"rgba(78, 115, 223, 1)"}]},"options":{"maintainAspectRatio":false,"legend":{"display":false,"labels":{"fontStyle":"normal"}},"title":{"fontStyle":"normal"},"scales":{"xAxes":[{"gridLines":{"color":"rgb(234, 236, 244)","zeroLineColor":"rgb(234, 236, 244)","drawBorder":false,"drawTicks":false,"borderDash":["2"],"zeroLineBorderDash":["2"],"drawOnChartArea":false},"ticks":{"fontColor":"#ffffff","fontStyle":"normal","padding":20}}],"yAxes":[{"gridLines":{"color":"rgb(234, 236, 244)","zeroLineColor":"rgb(234, 236, 244)","drawBorder":false,"drawTicks":false,"borderDash":["2"],"zeroLineBorderDash":["2"]},"ticks":{"fontColor":"#ffffff","fontStyle":"normal","padding":20}}]}}}' />
                </div>
              </div>
            </div>
          </div>
          <div className='col-lg-5 col-xl-4'>
            <div className='card shadow mb-4'>
              <div className='card-header d-flex justify-content-between align-items-center'>
                <h6 className='text-primary fw-bold m-0 card-header-text'>Revenue Sources</h6>
                <div className='dropdown no-arrow'>
                  <button
                    className='btn btn-link btn-sm dropdown-toggle'
                    aria-expanded='false'
          ...
          <div className='col-lg-6 mb-4'>
            <div className='card shadow mb-4'>
              <div className='card-header py-3'>
                <h6 className='text-primary fw-bold m-0 card-header-text'>Projects</h6>
              </div>
              <div className='card-body'>
                ...
                <div className='progress mb-4'>
                  <div
                    className='progress-bar bg-danger w-1/5'
                    aria-valuenow={20}
                    aria-valuemin={0}
                    aria-valuemax={100}
                  >
                ...
                <div className='progress mb-4'>
                  <div
                    className='progress-bar bg-warning w-2/5'
                    aria-valuenow={40}
                    aria-valuemin={0}
                    aria-valuemax={100}
                  >
                ...
                <div className='progress mb-4'>
                  <div
                    className='progress-bar bg-info w-4/5'
                    aria-valuenow={80}
                    aria-valuemin={0}
                    aria-valuemax={100}
                  >
                ...
                <div className='progress mb-4'>
                  <div
                    className='progress-bar bg-success w-full'
                    aria-valuenow={100}
                    aria-valuemin={0}
                    aria-valuemax={100}
                  >
            ...
            <div className='card shadow mb-4'>
              <div className='card-header py-3'>
                <h6 className='text-primary fw-bold m-0 card-header-text'>Todo List</h6>
              </div>
