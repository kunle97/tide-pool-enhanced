...
import { calculateTotalArea, numberWithCommas } from '@/helpers/util';
...
const UnderReviewCruises = () => {
  ...
  async function fetchCruises() {
    ...
    try {
      const data = await apiClient(UNDER_REVIEW_CRUISES_API_URL, { method: 'GET' });
      setCruises(data);
    } catch (error) {
      console.error(error);
    }
      ...
      <div className='d-flex flex-column' id='content-wrapper'>
        <div id='content'>
          ...
          <div className='container-fluid'>
            <h2 className='text-light '>GMRT Cruises Under Reveiw</h2>
